	...
	Click()
		if(src in usr.contents)
			...
			if(!usr.Rinnegan)
				...
				viewers() << "<font color = white>(*<font color=[usr.SayFont]>[usr]'s eyes turn to a dim shade of grey as rings form around their pupil.<font color = white>*)"
