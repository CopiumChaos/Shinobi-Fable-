...
var/Perks={"<html><head><center><title>Perks</title></center></head><body background=https://www.designbolts.com/wp-content/uploads/2012/11/Nami-beautiful-black-seamless-Photoshop-pattern-for-website-backgrounds.jpg>
...
Marksman<br><br>
<hr>
<font size=8>Attention:</font size><br>
<font size=4><i>Perks(aside from the grind perks) do not need to be roleplayed for, im currently working on integrating all the perks into the spend RPP system, but until then you can simply ask an admin, and so long as you have the pre-reqs for your desired perk they will be given to you.
</i><hr>
...
<b><u><i><font color=grey>Grindable Perks</b></u></i></font color><Br><br>
Understanding of chakra:This character has grasped the very basic concepts of chakra. While seemingly simple at first, this characterÂ’s knowledge and understanding of chakra have been enhanced greatly by their consistent usage of chakra and meditation. This enables them to produce chakra at a greater quantity while having enough control in manipulating chakra at its finest."
<br>
(C- rank, T2 Chakra Control, 50 rps)
<br><br>
Elemental Attunement:This character has harnessed their attunement with an element beyond the average shinobi. This enables them to be virtually sense the element around them whenever it is being used, making them harder to combat with their elemental attunement. Naturally, they are better combatants when using their element, to the point that their element can achieve several other properties such as a change of color. Their elements can also start influencing their appearances."
<br>
(B- rank, Elemental training T3, 100 rps)
<br><br>
Fist Hardening: his character has gone through traditional martial arts conditioning. They have broken and then mended their fists in certain ways to harden them into tougher, more lethal weapons. This excruciating process has reshaped their hands into rock-solid instruments of suffering
<br>
(T3 tai , C- rank, 100 rps)
<br><br>
Chakra Refinement: This character’s capabilities of using chakra has been expounded on greatly. They are better at refining it which is a specified manner of controlling it. Rather than merely increasing the power of their techniques, they focus intently on increasing the quality of the chakra that they produce, enabling them to unleash techniques with a superior chakra structure and composition than the average nin. "
<br>
(T3 Chakra Control, B- rank, 100 rps)
<br><br>
Bullseye: This character has honed their craft to unbeleivable levels-their hand eye coordination allowing them to perform jaw dropping feats with long ranged weaponry.
<br>
(T2 Marksman, C- rank, T2 sight, 100 rps)
<br><br>
...
<font color=green>Baguazhang: This character has started to practice the martial art form Baguazhang. It is a completely unorthodox fighting style that revolves around circular stepping and flowing in and out of the harm’s way. This style makes use of skill rather than raw strength, and they are capable of catching enemies off guard by flowing out of the ways of their attack before retaliating with numerous stunning blows." T1-T4 <br><br>

<font color=green>Judo: This character has decided to practice and learn about Judo: a grappling-based and throwing-based martial art. They have enough strength and skill in making use of their opponent’s weight to throw them towards the ground, but they still struggle and fumble with their attempts that makes it harder for them to go through the proper procedures. While still vestigial, they do have some skill and experience in Judo" T1-T4<br><br>

<font color=green>Claws Beginner: This character has just begun to study the vicious art of fighting with clawed gloves. Alternatively, they might have gained claws through mutation, transformation or simple clan genetics -- but at this level, they're capable of little more than adding some lethality to their standard Taijutsu style, and may even be less effective with their claws than with bare fists. T1-T4 <br><br>

<font color=blue>Speed Freak: This character is a speed freak. They have chosen to prioritize their speed over their raw might. Through this, they have attained the ability to make use of their speed rather than their strength to attack their foes. At this stage, they are only capable of moving fast and using the built up momentum to strike their foes. Note: Requires Speed 1. Only purchasable on Setup. T1-T4<br><br>
...
<font color=gr>Marksman: The Marksman has incredible aim and throw weapons with such speed and precision, that they rarely miss. Their projectiles are almost always on target, and they even sometimes have a homing property to them. Note: Requires a sensory perk such as sight, sensing, -or- smell. T1-T4<br><br>
...
<font color=purple>Sub Zero: This characters sway over ice is immensely potent, even by Yuki standards. They constantly exude a frigid bone chilling cold, capable of freezing small sources of water by just being near it. Additionally, they are capable of instantly freezing large bodies of water on command, and even water based jutsu provided they match or beat out the water jutsus power
