...
turf/KuraiClothingIn
	Enter(mob/M)
		if(istype(M,/mob))
			if(M.client)
				M.loc = locate(175,283,17)
				M.overlays -= 'Swim.dmi'
		layer = TURF_LAYER + 1

turf/KuraiClothingOut
	Enter(mob/M)
		if(istype(M,/mob))
			if(M.client)
				M.loc = locate(95,203,16)
				M.overlays -= 'Swim.dmi'
		layer = TURF_LAYER + 1
...
turf/KuraiWeaponsIn
	Enter(mob/M)
		if(istype(M,/mob))
			if(M.client)
				M.loc = locate(190,283,17)
				M.overlays -= 'Swim.dmi'
		layer = TURF_LAYER + 1

turf/KuraiWeaponsOut
	Enter(mob/M)
		if(istype(M,/mob))
			if(M.client)
				M.loc = locate(97,203,16)
				M.overlays -= 'Swim.dmi'
		layer = TURF_LAYER + 1
...
turf/KumoAcadOut
	Enter(mob/M)
		if(istype(M,/mob))
			if(M.client)
				M.loc = locate(190,273,1)
				M.loc = locate(191,273,1)
				M.overlays -= 'Swim.dmi'
turf/KumoAcadIn
	Enter(mob/M)
		if(istype(M,/mob))
...
turf/KumoHospOut
	Enter(mob/M)
		if(istype(M,/mob))
			if(M.client)
				M.loc = locate(181,198,1)
				M.loc = locate(182,198,1)
				M.overlays -= 'Swim.dmi'
turf/KumoHospIn
	Enter(mob/M)
		if(istype(M,/mob))
...
turf/TeleporterKuraiIn
	Enter(mob/M)
		if(istype(M, /mob/))
			if(M.client)
				M.loc = locate(2,M.y,16)
				M.overlays -= 'Swim.dmi'

turf/TeleporterKuraiOut
	Enter(mob/M)
		if(istype(M, /mob/))
			if(M.client)
...
turf
	Stairy
		icon='donttriponthese.dmi'

turf
	BlackMountain
		icon='Blackmountain.dmi'
		Left
			icon_state="Left"
			density=1
		Right
		...
		Trim2
			...
			density=1
		PlainBottom3
			icon_state="PlainBottom3"
			density=1
		PlainBottom
			icon_state="PlainBottom"
			density=1
		PlainMiddle
			icon_state="PlainMiddle"
			density=1
		Path
			icon_state="Path"
		WhatTheFuck
			icon_state="MiddlePath"
		TopLeft
			icon_state="TopLeft"
		TopRight
			icon_state="TopRight"
		...
		StairsBottomLeft
			icon_state="bottomstairsleft"
		StairsBottomRight
			icon_state="bottomstairsright"
		PL
			icon_state="PL"
		PM
			icon_state="PM"
...
turf
	GrassyCliff
		...
		RightTop
			...
			density=1
		CurveBottom
			icon_state="CurveBottomRight"
		LeftCurveBottom
			icon_state="LeftCurveBottom"
		TopCurve
			icon_state="TopCurve"
		LeftCurve
			icon_state="LeftCurve"
		RightCurve
			icon_state="RightCurve"
		RoundBottomRight
			icon_state="RoundBottomright"
		RoundBottomMiddle
			icon_state="Roundbottommiddle"
		RoundBottomleft
			icon_state="Roundbottomleft"
		Kcurve
			icon_state="kcurve"
		Kcurve2
			icon_state="kcurve2"
		...
		Kedge4
			icon_state="kedge4"
		TopTrimmy
			icon_state="TopTrimmy"

obj
	Kdark
		icon='KuraiDarkness.dmi'
		Darkie
			icon_state="Darkness"
			layer = TURF_LAYER+100
			mouse_opacity = 0
turf
	KuraiDark
		icon='KuraiDarkness.dmi'
		Darkie
			icon_state="Darkness"
			layer = TURF_LAYER+102
			mouse_opacity = 0

turf
	RailingNew
		icon='RailingKono.dmi'
		Left
			icon_state="Left"
		Right
			icon_state="Right"
...
turf
	Kuraigakure
		icon='Kuraigakure Terrain.dmi'
		Grass
			icon_state="Grass"
		Path
			icon_state="Path"
		GrassEdgeLeft
			icon_state="GrassEdge1"
		GrassEdgeTop
			icon_state="GrassEdge2"
		GrassEdgeRight
			icon_state="GrassEdge3"
		GrassEdgeBottom
			icon_state="GrassEdge4"
turf
	SnowBridge
		icon='SnowBridge.dmi'
		layer=MOB_LAYER+1
...
turf
	Glacier
		icon='Glacie.dmi'
		BigGlacier
			icon_state="Glacier 1"
turf
	SmallGlacier
		icon='Small Glacier.dmi'
		icon_state="Glacier"
...
turf
	SnowCliff
		...
		StairsBottom2
			icon_state="StairsBottom2"
		StairsTop
			icon_state="StairsTop"
		StairsTop2
			icon_state="Stairstop2"
		StairsTrim
			icon_state="StairsTopTrim"
		StairsTrim2
			icon_state="Stairstrim2"
...
turf/Terrain
	...
	Sandcorner2
		icon_state="sand_corner2"
	Sandcorner3
		icon_state="sand_corner3"
	Sandcorner4
		icon_state="sand_corner4"
...
turf
	Caveboy
		Cavey
			icon='CliffCave.dmi'
			CaveEntrance
				icon_state="CaveEntrance"
				layer=MOB_LAYER+1
turf
	HugeTreeShit
		BigAssTreeMF
			icon='HugeAssTree.dmi'
			layer=MOB_LAYER+1
turf
	Konoha
		Stand
...
turf
	KirBuilding
		...
		Kiribuildingleft
			icon='KAcad.dmi'
			icon_state="Kiribuildingleft"
			layer=MOB_LAYER+1
		Kiribuildingright
			icon='KAcad.dmi'
			icon_state="kiribuildingright"
			layer=MOB_LAYER+1
		Kiribuildingmiddle
			icon='KAcad.dmi'
			icon_state="kiribuildingmiddle"
			layer=MOB_LAYER+1
	DoorR
		icon='KDoor.dmi'
		icon_state="CloseR"
